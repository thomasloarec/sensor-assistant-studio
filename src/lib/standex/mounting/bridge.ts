...
// La trajectoire du modèle importé (course, pivot, axe, amplitude) appartient à
// la machine de l'utilisateur : déplacer le COUPLE capteur/aimant ne la réécrit
// jamais. Seules les poses des deux composants sont modifiées.
